...
title: Calibration
description:
  In the week 11 stand-up, argue for a classmate's field report in a
...
> Be the manager in the room. Argue for someone else's work. Then explain
> what happened.

On the Monday of week 11 you are assigned a classmate's field report. You
have until Thursday to read it. In the stand-up, groups of eight sit with a
tutor in the chair. The tutor has two "exceeds" slots, five "meets", and one
"below" that must be filled. Each person argues for their assigned report for
three minutes. Then the room calibrates, the way week 1 described.

Afterwards, with the ratings fixed, you write one page explaining the
...
Your three minutes, in the room. Then one page, in the course forum, by
midnight. This assessment is the course's own system applied to your work;
the policies page has said so since week 1.
